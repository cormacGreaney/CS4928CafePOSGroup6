...
public class Week6CharacterizationTests {
    ...
    @Test void loyalty_discount_card_payment() {
        ...
        // Latte (Large) = 3.20 + 0.70 = 3.90; qty 2 => 7.80; 5% => 0.39; discounted=7.41; tax 0.74; total 8.15
    ...
    @Test void coupon_fixed_amount_and_qty_clamp() {
        ...
        // qty clamped to 1; Espresso+SHOT = 3.30; coupon1 => -1 => 2.30; tax 0.23; total 2.53
